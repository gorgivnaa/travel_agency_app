...
class TourServiceImpl implements TourService {
    ...
    public List<Tour> getAllTours(Authentication authentication) {
        ...
        List<Tour> popularToursBySeason = tourRepository.findPopularToursBySeason(months);
        if (authentication == null) {
            return popularToursBySeason;
        }
        ...
        return userBookings.isEmpty()
                ? popularToursBySeason
                : tourRepository.findNearestAvgPriceTours(userId);
    }
